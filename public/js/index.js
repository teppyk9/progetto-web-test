document.addEventListener('DOMContentLoaded', () => {
  ...
  if (artisansContainer) {
    fetch('/api/artisans/featured')
        ...
        .catch(error => {
          console.error('Errore nel caricamento degli artigiani in evidenza:', error);
          artisansContainer.innerHTML = '<p class="text-red-500">Impossibile caricare gli artigiani in evidenza.</p>';
        });
  } else {
    console.warn('Contenitore artigiani in evidenza non trovato.');
  }
  ...
  if (productsContainer) {
    fetch('/api/products/featured')
        ...
        .catch(error => {
          ...
          productsContainer.innerHTML = '<p class="text-red-500">Impossibile caricare i prodotti in evidenza.</p>';
        });
  } else {
